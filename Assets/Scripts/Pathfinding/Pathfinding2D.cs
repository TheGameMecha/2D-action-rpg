...
public class Pathfinding2D : MonoBehaviour
{
    ...
    public void FindPath(Vector3 startPos, Vector3 targetPos)
    {
        ...
        seekerNode = GameManager.instance.levelGrid.NodeFromWorldPoint(startPos);
        targetNode = GameManager.instance.levelGrid.NodeFromWorldPoint(targetPos);
        ...
        while (openSet.Count > 0)
        {
            ...
            foreach (Node2D neighbour in GameManager.instance.levelGrid.GetNeighbors(node))
            {
